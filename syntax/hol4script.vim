...
" Verbatim port of HOL4's tools/editor-modes/vim/hol4script.vim (the regex
" fallback tier -- see ROADMAP.md Phase 5; known limitations in README.MD).
" Loads automatically for the hol4script filetype; a future tree-sitter
" parser takes precedence when available (vim.treesitter.start disables
" regex syntax per buffer).
